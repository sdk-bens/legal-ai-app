...
//       try {
//         const response = await axios.get(`http://127.0.0.1:8000/get_landlord_form/${selectedOption}.pdf`);
...
//       {pdfContent && (
//         <div>
//           <object data={`http://127.0.0.1:8000/get_landlord_form/${selectedForm}.pdf`} width="800" height="600"></object>
...
function LandlordForms() {
  ...
  useEffect(() => {
    const fetchFormOptions = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:8000/get_form_options?category=landlord');
